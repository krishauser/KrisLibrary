...
MT_Scalar DT_Polyhedron::supportH(const MT_Vector3& v) const 
{
	...
	//std::cout << "Poly: supportH v = " << v[0] << " " << v[1] << " " << v[2] << " h = " << h << std::endl;
    return h;
}
...
MT_Point3 DT_Polyhedron::support(const MT_Vector3& v) const 
{
	...
	//std::cout << "Poly: v = " << v[0] << " " << v[1] << " " << v[2] << std::endl;
	//std::cout << "Poly: support = " << (*this)[m_curr_vertex][0] << " " << (*this)[m_curr_vertex][1] << " " << (*this)[m_curr_vertex][2] << "\n";
