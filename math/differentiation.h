...
void HessianForwardDifference(VectorFieldFunction& f,Vector& x,Real h,std::vector<Matrix>& H);
...
void HessianCenteredDifference(VectorFieldFunction& f,Vector& x,Real h,std::vector<Matrix>& H);
...
void HessianForwardDifference(VectorFieldFunction& f,Vector& x,const Vector& h,std::vector<Matrix>& H);
...
void HessianCenteredDifference(VectorFieldFunction& f,Vector& x,const Vector& h,std::vector<Matrix>& H);
