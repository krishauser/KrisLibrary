...
IF(NOT DEFINED ${KRISLIBRARY_ROOT})
  SET(KRISLIBRARY_ROOT .. CACHE PATH DESCRIPTION "Path for finding KrisLibrary external dependencies")
ENDIF( )

SET(KRISLIBRARY_INCLUDE_DIRS "" CACHE STRING DESCRIPTION "KrisLibrary include directories")
SET(KRISLIBRARY_LIBRARIES "" CACHE STRING DESCRIPTION "KrisLibrary link libraries")
SET(KRISLIBRARY_DEFINITIONS "" CACHE STRING DESCRIPTION "KrisLibrary defines")
...
# GLUI
SET(GLUI_ROOT_DIR "${KRISLIBRARY_ROOT}/glui-2.36/src" CACHE PATH DESCRIPTION "Root of src directory in GLUI Package")
# GLUI
FIND_PACKAGE(GLUI)
IF(GLUI_FOUND)
...
# GLPK
SET(GLPK_ROOT "${KRISLIBRARY_ROOT}/glpk-4.52" CACHE PATH DESCRIPTION "Root of GLPK Package")
FIND_PACKAGE(GLPK)
IF(GLPK_FOUND)
...
# TinyXML
SET(TINYXML_ROOT "${KRISLIBRARY_ROOT}/tinyxml" CACHE PATH DESCRIPTION "Root of TinyXML Package")
...
# Assimp
SET(ASSIMP_ROOT "${KRISLIBRARY_ROOT}/assimp--3.0.1270-sdk" CACHE PATH DESCRIPTION "Root of Assimp package")
FIND_PACKAGE(Assimp)
IF(ASSIMP_FOUND)
