...
IF(ASSIMP3_INCLUDE_DIR)
  ...
  FIND_PATH( ASSIMP5_TEST assimp/aabb.h
    PATHS "${ASSIMP_ROOT}/include" )
  IF(ASSIMP5_TEST)
    MESSAGE(STATUS "Assimp configuration: detected version 5.x+ at ${ASSIMP_INCLUDE_DIR}")
    SET(ASSIMP_DEFINITIONS -DASSIMP_MAJOR_VERSION=5)
  ELSE(ASSIMP5_TEST)
